...
\chapter{Architectural design}
    ...
    \begin{itemize}
        ...
        \item createStudentVerificationCode(email, code): add a temporary verification code to the database linked to a email to be verified. 
    ...
    \begin{itemize}
        ...
        \item createEducatorVerificationCode(email, code): add a temporary verification code to the database linked to a email to be verified. 
        ...
        \item createEducatorToken(educatorID, token): add a new log in token linked to a educator. 
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item enrollInBattle(battleID): checks if the student is enrolled in the battle's tournament and if so it enroll the student in the battle. 
        ...
        \item insertEducator(query): add a educator with query data (username, email, telephone, and password). 
