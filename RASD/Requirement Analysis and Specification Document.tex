...
\usepackage{graphicx, array, amsthm, amssymb, amsmath, float, xcolor, thmtools, thmbox, geometry, listings}
...
\begin{figure}[H]
    ...
    \caption{This universe is simple and composed by two students competing in a the only one battle of a tournament togehter}
\end{figure}
