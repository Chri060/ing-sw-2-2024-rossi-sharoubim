...
\chapter{Specific requirements}
    ...
    \section{Functional Requirements}
        ...
        % usecase for the login of both students and educators 
        \usecase
        ...
        \begin{itemize}
            ...
            \item The user cannot join the selected tournament
        \end{itemize}
        }
        {In case of exception the system will notify user with a human-readable message}
        ...
        % usecase (Student) for the research of a tournament by the name
        \usecase{%\begin{figure}[H]\centering\includegraphics[width=0.9\linewidth]{images/tournamentaccess.png}\end{figure}%
        }        
        {\arabic{useCase}\stepcounter{useCase}}
        ...
        \begin{enumerate}
            ...
            \item The actor clicks on the create and join button 
        ...
        \begin{enumerate}
            \item The actor enters the tournament details page
            \item The system shows the tournament details page to the actor
            \item The actor clicks on the button linked to the repository 
        ...
        {Create a tournament}
        {Educator}
        {The actor clicks on create on the left tab}
        {
        \begin{enumerate}
